...
def output_markdown(
    ...
    lines: list[str] = []
    lines.append(f"# ⚾ FullCountProps Edge Report — {game_date}")
    lines.append("")
    lines.append(
    ...
    lines.append("---")
    lines.append(
        f"*Generated by FullCountProps Edge Finder | "
...
def output_twitter_threads(
    ...
    # Header tweet
    tweets.append(
        f"⚾ FullCountProps Edge Report — {game_date}\n\n"
...
def output_plain_text(
    ...
    lines.append(
        "  FullCountProps Edge Finder  |  github.com/fullcountprops/fullcountprops"
    )
    lines.append("=" * 60)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="FullCountProps Edge Finder — identify profitable betting edges",
...
def main() -> None:
    ...
    print("FullCountProps Edge Finder")
    print(f"{'=' * 40}")
