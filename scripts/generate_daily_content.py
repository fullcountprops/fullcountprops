#!/usr/bin/env python3
"""
generate_daily_content.py — FullCountProps
...
def format_email(enriched_list: list, game_date: str) -> str:
    ...
    header += "*Every factor visible. Every number explained. That's the FullCountProps glass-box model.*\n\n"
    header += "---\n\n"
    ...
    footer = "\n\n---\n\n"
    footer += "*Projections by FullCountProps | fullcountprops.com | @fullcountprops*\n"
...
def format_thread(enriched_list: list, game_date: str) -> list:
    ...
    hook = (
        f"⚾ FullCountProps Projections — {game_date}\n\n"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate daily content from FullCountProps projections"
    )
    parser.add_argument(
