...
>>> from simulator.prop_analyzer import PropAnalyzer, PropLine, PropReporter
...
from simulator.config import SimulationConfig
from simulator.game_engine import SimulationResult
...
class PropAnalysis:
    ...
    kelly_wager_pct:
        Final wager percentage of bankroll (Kelly x KELLY_FRACTION, capped at
        MAX_KELLY_BET).
    confidence_tier:
