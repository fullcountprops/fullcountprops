...
class StatcastFetcher:
    ...
    def _download_savant_csv(self, url: str) -> pd.DataFrame:
        ...
        try:
            ...
            logger.debug(
                "Savant CSV downloaded: %d rows x %d cols from %s",
...
class WeatherFetcher:
    ...
    is unknown a +/-45deg cone heuristic is used.
    """
    ...
    def _degrees_to_cardinal(degrees: float) -> str:
        """Convert a wind bearing (0-360deg) to an 8-point cardinal string."""
...
class DataPrepPipeline:
    ...
    def prepare_game_data(self, game: dict[str, Any]) -> GameData:
        ...
        logger.info(
            ...
            "away_lineup=%d batters, weather=%.1fdegF wind=%.1f mph %s",
            game_pk,
            len(gd.home_lineup),
            len(gd.away_lineup),
            gd.temp_f,
