# Full Count Props — Frontend Architecture Spec
...
- Full Count Props's projection accuracy for this specific pitcher
...
- "Every projection Full Count Props has ever made is logged and graded. We don't hide misses."
...
### Navigation Bar
```
[⚾ FULL COUNT PROPS]  [Today's Slate]  [Props]  [Accuracy]  [About]
```
