...
Glass-box MLB prop projection model.
Combines pitcher stats, batter stats, umpire accuracy, and catcher framing
to generate transparent, explainable prop predictions.

No black-box ML — every factor is logged and visible.
"""
...
def generate_projections_for_date(game_date: str = None) -> List[Dict]:
    ...
    props = load_json(f"data/props/props_{game_date}.json")
