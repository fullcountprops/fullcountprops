      ...
      <div className="min-h-screen bg-slate-950 text-slate-100">
        <div className="max-w-3xl mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-16">
            <StatBox value="2,500" label="Simulations / Game" />
          ...
          <SectionCard number="01" title="What Is Monte Carlo Simulation?">
            ...
            <p>
              ...
              realistic randomness at every plate appearance. After 2,500 runs,
          ...
          <SectionCard number="04" title="The Simulation">
            <p>
              Each of the 2,500 simulations plays out a complete baseball game,
            ...
            <p className="mt-4">
              After 2,500 full games, each player has a frequency distribution of
              outcomes. &quot;Corbin Burnes recorded 7+ Ks in 1,530 of 2,500 sims&quot;
