...
export function HomepageJsonLd() {
  const data = {
    ...
    description:
      'MLB prop betting analytics powered by Monte Carlo simulation. 5,000 sims per game, 24 Statcast features, glass-box factor breakdowns on every pick.',
    offers: [
      {
        '@type': 'Offer',
        name: 'Free Tier',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We run 5,000 Monte Carlo simulations per game at the plate-appearance level, using 24 Statcast features including park factors, umpire tendencies, and catcher framing data.',
        },
      },
      {
        '@type': 'Question',
